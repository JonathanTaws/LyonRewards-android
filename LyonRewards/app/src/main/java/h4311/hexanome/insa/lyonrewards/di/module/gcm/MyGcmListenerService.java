...
// todo : set constant
        registrationComplete.putExtra(MainActivity.ARG_ID_OFFER_READ, data.getString("id_offer"));
         ...
         */
        sendNotification(data.getString("id_offer"), data.getString("score"), data.getString("title"));
        // [END_EXCLUDE]
    }
    // [END receive_message]
    ...
    private void sendNotification(String idOffer, String points, String title) {
        // todo : redirect to offer fragment
       ...
       // intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
        ...
        NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(this)
                .setSmallIcon(R.drawable.icon_success_key_finished)
